...
<body class="w-full max-h-screen overflow-scroll text-white">
    ...
    <main class="w-full">
                        ...
                        <div class="col-start-3 py-2">
                            <div class="grid grid-cols-3 gap-4">
                                {{-- <div class="cursor-pointer text-gray-400">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" width="26" height="26" class="">
                                        <path stroke-linecap="round" stroke-linejoin="round" d="M9 8.25H7.5a2.25 2.25 0 00-2.25 2.25v9a2.25 2.25 0 002.25 2.25h9a2.25 2.25 0 002.25-2.25v-9a2.25 2.25 0 00-2.25-2.25H15m0-3l-3-3m0 0l-3 3m3-3V15" />
                                    </svg>
                                </div> --}}
                                <div class="cursor-pointer">
                                    <svg version="1.1" id="df9d3429-f0ef-48b5-b5eb-f9d27b2deba6" x="0" y="0" viewBox="0 0 24 24" width="26" height="26" class="">
                                        <path fill="#AEBAC1" d="M12.072 1.761a10.05 10.05 0 0 0-9.303 5.65.977.977 0 0 0 1.756.855 8.098 8.098 0 0 1 7.496-4.553.977.977 0 1 0 .051-1.952zM1.926 13.64a10.052 10.052 0 0 0 7.461 7.925.977.977 0 0 0 .471-1.895 8.097 8.097 0 0 1-6.012-6.386.977.977 0 0 0-1.92.356zm13.729 7.454a10.053 10.053 0 0 0 6.201-8.946.976.976 0 1 0-1.951-.081v.014a8.097 8.097 0 0 1-4.997 7.209.977.977 0 0 0 .727 1.813l.02-.009z"></path>
                                        <path fill="#009588" d="M19 1.5a3 3 0 1 1 0 6 3 3 0 0 1 0-6z"></path>
                                    </svg>
                                </div>
                                <div class="cursor-pointer">
                                    <svg viewBox="0 0 24 24" width="26" height="26" class="">
                                ...
                                <div class="cursor-pointer">
                                    <svg viewBox="0 0 24 24" width="26" height="26" class="">
                                        <path fill="#AEBAC1" d="M12 7a2 2 0 1 0-.001-4.001A2 2 0 0 0 12 7zm0 2a2 2 0 1 0-.001 3.999A2 2 0 0 0 12 9zm0 6a2 2 0 1 0-.001 3.999A2 2 0 0 0 12 15z"></path>
                                    </svg>
                                </div>
                            </div>
                        </div>
        ...
        <div class="pt-14 h-screen" style="background-color: #121A21;">
                ...
                <div class="h-17">
                    <div class="cursor-pointer grid grid-cols-12">
                        ...
                        <div class="col-span-10 py-2">
                            <div class="flex justify-between py-1 mr-5">
